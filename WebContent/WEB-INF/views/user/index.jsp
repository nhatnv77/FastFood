	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link" href="home.htm"> <i
					class="fa fa-power-off"></i> <span>ĐĂNG XUẤT</span></a></li>
			...
			<div class="bg-light p-5 rounded">
				...
				<div id="content">
					<div class="border">
						...
						<br /> <a href="insertUser.htm" class="btn btn-success">Thêm</a> <br />
						<br />
						<table class="table table-hover table-bordered">
							...
							<c:forEach var="item" items="${pagedListHolder.pageList}">
								<tr>
									...
									<td>${item.username}</td>
									<td>${item.password}</td>
									<td><a href="updatekh/${item.idUser}.htm"
										class="btn btn-primary">Sửa</a> <a
										href="deletekh/${item.idUser}.htm"
