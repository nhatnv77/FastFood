...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="account.htm" >
...
<%-- 					enctype="multipart/form-data" --%>
					...
					<div class="ip">
						<label>Mã</label>
						<form:input path="idProduct" readonly="true" />
					...
					<div class="ip">
						<label>Hình</label>
						<img src="${pageContext.request.contextPath}/resources/img/${products.getImage()}" height="60px" />
					...
					<div style="margin-left: 170px; margin-top: 10px;">
						...
						<a href="admin/product.htm" class="btn btn-danger">Thoát</a>
					</div>
			</form:form>
