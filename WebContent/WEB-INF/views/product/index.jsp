	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed"
				href="user.htm"> <i class="fa fa-user"></i> <span>KHÁCH
						HÀNG</span>
			</a></li>

			<!-- Nav Item - Charts -->
			<li class="nav-item"><a class="nav-link" href="product.htm">
					<i class="fa fa-tree"></i> <span>HÀNG HÓA</span>
			</a></li>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div class="bg-light p-5 rounded">
				...
				<c:url value="${root }/admin/product.htm" var="pagedLink">
				...
				<div id="content">
					<div class="border">
						...
						<br /> <a href="insertsp.htm" class="btn btn-success">Thêm</a> <br />
						<br />
						<table class="table table-hover table-bordered">
							...
							<c:forEach var="item" items="${pagedListHolder.pageList}">
								<tr>
									...
									<td>${item.type}</td>
									<td><img
										src="${pageContext.request.contextPath}/resources/img/products/${item.image}"
										height="60px" /></td>
									<td>${item.number}</td>
									<td><a href="updatesp/${item.idProduct}.htm"
										class="btn btn-primary">Sửa</a> <a
										href="deleteProduct/${item.idProduct}.htm"
										class="btn btn-danger xoa-hh">Xóa</a></td>
								</tr>
							</c:forEach>
						</table>
						<div>
